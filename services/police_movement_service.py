...
from models.police_movement import PoliceMovement, MovementState, MovementAction, VendorType
...
class PoliceMovementService:
    ...
    def get_movements_by_reservation(self, reservation_id: UUID) -> List[PoliceMovement]:
    ...
    def get_movements_by_date_range(self, start_date: date, end_date: date) -> List[PoliceMovement]:
