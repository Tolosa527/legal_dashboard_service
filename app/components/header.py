    ...
    return rx.box(
        ...
        rx.container(
            rx.vstack(
                ...
                rx.vstack(
                    rx.text(
                        "Real-time analytics and monitoring for police data services",
                        size="4",
...
def compact_header() -> rx.Component:
    """Compact header variant for smaller screens or specific use cases."""
    return rx.box(
        rx.container(
            rx.hstack(
                rx.hstack(
                ...
                rx.hstack(
                    rx.box(
                        rx.hstack(
                            ...
                            rx.text("Live", size="1", color="white", font_weight="600"),
                            spacing="2",
                            align="center",
                        ),
                        padding="6px 10px",
