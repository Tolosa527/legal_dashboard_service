...
class PoliceMovement:
    ...
    def from_db_row(cls, row: Dict[str, Any]) -> "PoliceMovement":
        ...
        return cls(
            ...
            reservation_id=(
                ...
                if row.get("reservation_id") and isinstance(row["reservation_id"], str)
                else row.get("reservation_id")
            ),
            tax_data=tax_data,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_sent_date": (
                self.last_sent_date.isoformat() if self.last_sent_date else None
            ),
            "data": self.data,
            "reason": self.reason,
    ...
    def __str__(self) -> str:
        ...
        return (
            f"PoliceMovement(id={self.id}, action={self.action.value}, "
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"PoliceMovement(id={self.id}, created_at={self.created_at}, "
